...
const AR = {
  ...
  Discount: 'حسم',
  off: 'حسم',
  'Money off the whole sale': 'حسم على كامل الفاتورة',
  'Take the discount off': 'إلغاء الحسم',
  'Hide sold out': 'إخفاء النافد',
  'Leave out anything the shelf has none of': 'إخفاء الأصناف التي نفدت من الرف',
  Subtotal: 'المجموع',
  Tax: 'الضريبة',
  Total: 'الإجمالي',
  'In LBP': 'بالليرة',
  ...
  'A new version of the app is ready.': 'نسخة جديدة من التطبيق جاهزة.',
  'Reload now': 'حدّث الآن',
  'Later': 'لاحقاً',
  'Not now': 'ليس الآن',
